...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            if (newNumSystem > 0 && newNumSystem < 37) {
                mainFunc(sourceNumSystem, sourceNumber, newNumSystem);
            } else {
    ...
    public static void mainFunc(int sourceNumSystem, String[] sourceNumber, int newNumSystem) {
        ...
        System.out.println(convertedFractionalNumber);
